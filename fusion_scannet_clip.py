...
def main(args):   
    ...
    selected_scenes = [
        "scene0353_00", "scene0356_02", "scene0645_01",
        "scene0435_02", "scene0193_01"
    ]
    data_paths = sorted(glob(join(data_root, split, '*.pth')))
    data_paths = [path for path in data_paths if any(scene in path for scene in selected_scenes)]
